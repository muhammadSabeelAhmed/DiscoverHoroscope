...
public class LoginActivity extends Activity implements View.OnClickListener {
    ...
    private String btn_create_account_txt = "<font color=#FFFFFF>Not account yet?</font>" + " " + "<font color=#ffcc00>Sign Up Free</font>";
    ...
    public void onClick(View v) {
        switch (v.getId()) {
                                    ...
                                    .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                                        ...
                                        public void onComplete(@NonNull Task<AuthResult> task) {
                                            if (!task.isSuccessful()) {
                                                ...
                                                global.changeActivity(LoginActivity.this, new DashboardActivity());
            ...
            case R.id.btn_reset_password:
                Toast.makeText(LoginActivity.this, "Available soon", Toast.LENGTH_LONG).show();
       /*         global.HideKeyBoard(LoginActivity.this, v);
